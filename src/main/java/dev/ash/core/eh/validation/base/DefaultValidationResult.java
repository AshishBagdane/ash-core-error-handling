...
/**
 * Default implementation of {@link ValidationResult} interface. Provides an immutable container for validation status and errors.
 *
 * <p>This class is used to create both successful validation results (with no errors)
 * and failure results (containing validation errors). It provides static factory methods for convenient creation of common validation results.</p>
 *
